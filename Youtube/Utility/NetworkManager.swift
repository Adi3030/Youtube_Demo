...
class NetworkManager {
    ...
    func getVideosData(completion: @escaping ((VideosModel?, String?) -> Void)){


        guard let endPointURL = Bundle.main.url(forResource: "VideoAPIResponse", withExtension: "json") else {
            completion(nil, "could not file Response Data")
            return
        }
